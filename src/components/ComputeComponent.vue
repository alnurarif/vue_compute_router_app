...
<div class="max-w-md mx-auto mt-8 p-4">
    <h1 class="text-2xl font-semibold mb-4">User Details (Computed)</h1>
    <div class="flex justify-center">
        <img :src="user.img" class=" w-1/4 pr-5 pt-5 pb-5">
        <div class="w-3/4 p-5">
            <div class="mb-4">
                <label for="birthYear" class="block text-gray-600 text-sm">Birth Year: {{ birthYear }}</label>
            </div>
            <div>
                <label for="votingStatus" class="block text-gray-600  text-sm">Voting Status: {{ canVote }}</label>
            </div>
        </div>
    </div>
    <div class="mb-4">
